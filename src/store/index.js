...
export default new Vuex.Store({
  state: {
    ...
    allCommonIngredientsSearchURL:
      "http://localhost:8000/api/v1/search-common-ingredients/",
    ...
    userAddIngredientRecipeURL:
      "http://localhost:8000/api/v1/recipe/RECIPEID/ingredient/",
    createIngredientURL: "http://localhost:8000/api/v1/ingredient/",
    classifyIngredientAsCommonIngredientURL:
      "http://localhost:8000/api/v1/classify-ingredient-common-ingredient/",
    ...
    userCommonIngredientsURL:
      "http://localhost:8000/api/v1/usercommoningredients/",
    userCommonIngredientsSearchURL:
      "http://localhost:8000/api/v1/search-user-common-ingredients/",

    // get/put/delete by :id
    userCommonIngredientURL:
      "http://localhost:8000/api/v1/usercommoningredient/",
    addUserCommonIngredientURL:
      "http://localhost:8000/api/v1/add-usercommoningredient/",
  ...
  mutations: {
    ...
    setUserSelectedIngredientName(state, name) {
      state.userSelectedIngredient.name = name;
    },
    ...
    toggleUserAvailableRecipesTableLoading(
      state,
      userAvailableRecipeTableLoading
    ) {
    ...
    removeUserCommonIngredient(state, userCommonIngredientId) {
      state.userCommonIngredients.results = state.userCommonIngredients.results.filter(
        (ing) => ing.id != userCommonIngredientId
      );
    },
  ...
  actions: {
    ...
    searchAndFetchAllCommonIngredients({ commit }, obj) {
      ...
      obj.vm.$http
        .get(this.state.allCommonIngredientsSearchURL, options)
        .then(function(rsp) {
    ...
    fetchAllCommonIngredients({ commit }, vm) {
      ...
      vm.$http
        .get(this.state.allCommonIngredientsURL, options)
        .then(function(rsp) {
          commit("setAllCommonIngredients", rsp.data);
        });
    },
    fetchNextAllCommonIngredients({ commit }, vm) {
      ...
      vm.$http
        .get(this.state.allCommonIngredients.next, options)
        .then(function(rsp) {
          commit("setAllCommonIngredients", rsp.data);
        });
    },
    fetchPreviousAllCommonIngredients({ commit }, vm) {
      ...
      vm.$http
        .get(this.state.allCommonIngredients.previous, options)
        .then(function(rsp) {
          commit("setAllCommonIngredients", rsp.data);
        });
    },
    ...
    searchAndFetchUserAvailableRecipes({ commit }, obj) {
      ...
      commit(
        "toggleUserAvailableRecipesTableLoading",
        obj.vm.$store.state.userAvailableRecipeTableLoading
      );
      let options = {
        headers: { "Content-type": "application/json" },
        params: {
      ...
      obj.vm.$http
        .get(this.state.userAvailableRecipesURL, options)
        .then(function(rsp) {
    ...
    fetchUserAvailableRecipes({ commit }, vm) {
      ...
      commit(
        "toggleUserAvailableRecipesTableLoading",
        vm.$store.state.userAvailableRecipeTableLoading
      );
      let options = {
        headers: { "Content-type": "application/json" },
        params: {
          "missing-ingredients-limit":
            vm.$store.state.allowedMissingIngredients,
        },
        withCredentials: true,
      };
      vm.$http
    ...
    fetchNextUserAvailableRecipes({ commit }, vm) {
      ...
      vm.$http
        .get(this.state.userAvailableRecipes.next, options)
        .then(function(rsp) {
          commit("setUserAvailableRecipes", rsp.data);
          commit(
            "toggleUserAvailableRecipesTableLoading",
    ...
    fetchPreviousUserAvailableRecipes({ commit }, vm) {
      ...
      vm.$http
        .get(this.state.userAvailableRecipes.previous, options)
        .then(function(rsp) {
          commit("setUserAvailableRecipes", rsp.data);
          commit(
            "toggleUserAvailableRecipesTableLoading",
    ...
    fetchUserCommonIngredients({ commit }, obj) {
      ...
      obj.vm.$http
        .get(this.state.userCommonIngredientsURL, options)
        .then(function(rsp) {
    ...
    fetchNextUserCommonIngredients({ commit }, vm) {
      ...
      vm.$http
        .get(vm.$store.state.userCommonIngredients.next, options)
        .then(function(rsp) {
          commit("setUserCommonIngredients", rsp.data);
        });
    },
    fetchPreviousUserCommonIngredients({ commit }, vm) {
      ...
      vm.$http
        .get(vm.$store.state.userCommonIngredients.previous, options)
        .then(function(rsp) {
          commit("setUserCommonIngredients", rsp.data);
        });
    },
    removeUserCommonIngredient({ commit }, obj) {
      ...
      obj.vm.$http
        .delete(
          `${this.state.userCommonIngredientURL}${obj.userCommonIngredientId}/`,
          options
        )
        .then((rsp) => {
          if (rsp.status == 204) {
    ...
    addUserCommonIngredient({ commit }, obj) {
      ...
      obj.vm.$http
        .post(`${this.state.addUserCommonIngredientURL}`, options)
        .then((rsp) => {
    ...
    searchAndFetchUserCommonIngredients({ commit }, obj) {
      ...
      obj.vm.$http
        .get(this.state.userCommonIngredientsSearchURL, options)
        .then(function(rsp) {
          commit("setUserCommonIngredients", rsp.data);
        });
    },
    ...
    fetchUserSelectedRecipe({ commit }, obj) {
      ...
      obj.vm.$http
        .get(`${this.state.userSelectedRecipeURL}${obj.recipeId}`, options)
        .then(function(rsp) {
    ...
    userCreateRecipe({ commit }, obj) {
      ...
      return obj.vm.$http
        .post(this.state.userSelectedRecipeURL, options)
        .then(function(rsp) {
    ...
    addIngredientRecipe({ commit }, obj) {
      ...
      obj.vm.$http
        .post(
          this.state.userAddIngredientRecipeURL.replace(
            "RECIPEID",
            obj.recipe_id
          ),
          options
    ...
    createIngredient({ commit }, obj) {
      ...
      return obj.vm.$http
        .post(this.state.createIngredientURL, options)
        .then(function(rsp) {
    ...
    updateIngredient({ commit }, obj) {
      console.log(commit);
      console.log("updating ingredient", obj);
      let options = {
        headers: { "Content-type": "application/json" },
        params: {},
      ...
      return obj.vm.$http
        .put(`${this.state.createIngredientURL}${obj.ingredient_id}`, options)
        .then(function(rsp) {
          console.log("rsp is ", rsp);
          commit("setUserSelectedIngredient", rsp.data);
          return rsp.data;
        });
    },
    ...
    classifyIngredient({ commit }, obj) {
      ...
      return obj.vm.$http
        .post(this.state.classifyIngredientAsCommonIngredientURL, options)
        .then(function(rsp) {
          if (rsp.data.confidence > 0.96) {
            console.log(rsp.data);
            commit(
              "setUserNewIngredientCommonIngredient",
              rsp.data.common_ingredient
            );
            return rsp.data;
          }
        });
  ...
  getters: {
    search: (state) => (vm, search, searchTarget, path) => {
      const x = vm._.get(state, path).filter(
        (data) =>
          !search ||
          vm._.get(data, searchTarget)
            .toLowerCase()
    ...
    recipe: (state) => (id) => {
      return state.userAvailableRecipes.results.find(
        (recipe) => recipe.id == id
      );
    },
    ...
    ingredientRecipe: (state) => (ingredientId) => {
      return state.userSelectedRecipe.ingredients.find(
