  ...
  <div class="split-view">
    <el-row type="flex" class="row-bg" :gutter="40">
      <el-col :span="6"
        ><div class="grid-content">
          <h2 style="text-align: left">Available Recipes</h2>
        </div></el-col
      >
      <el-col :span="6"
        ><div
          class="grid-content"
          style="text-align: right;margin-top: 2.03em;"
        >
          <AllowedMissingIngredientsNumberInput /></div
      ></el-col>
      <el-col :span="6"
        ><div class="grid-content">
          <h2 style="text-align: left">Create Recipe</h2>
        </div></el-col
      >
      <el-col :span="6"
        ><div
    ...
    <el-row type="flex" class="row-bg" :gutter="40">
      <el-col :span="12" class="list-view"
        ><div class="grid-content"><UserAvailableRecipesTable /></div
      ></el-col>
      <el-col :span="12" class="list-view"
        ><div class="grid-content"><RecipeForm /></div
      ></el-col>
    </el-row>
  </div>
</template>
