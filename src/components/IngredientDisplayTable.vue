...
<div>
  <div style="text-align: left">
    <h3>{{this.$store.state.userNewIngredient.common_ingredient.display_name}}</h3> 
    <!-- {{this.$store.state.userNewIngredient.confidence}} -->
    <div style="padding-bottom: 20px"><div>
    Quantity: <el-input-number v-model="units" size="mini" :min="0" ></el-input-number></div><br /><div>
    Measurement:  <el-select v-model="measurement" placeholder="Select" size="mini">
        <el-option
