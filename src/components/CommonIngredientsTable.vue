    ...
    <el-table
      :data="
        this.$store.getters.search(
          ...
          search,
          'display_name',
          'allCommonIngredients.results'
        )
      "
      style="width: 100%"
      size="mini"
    >
      <el-table-column label="Name" prop="display_name" width="300px">
      </el-table-column>
      <el-table-column align="right">
        ...
        <template slot-scope="scope">
          <el-button size="mini" type="primary" @click="handleAdd(scope)"
            >Add</el-button
          >
        </template>
        <!--eslint-enable-->
...
export default {
  ...
  methods: {
    ...
    handleSearch: function() {
      this.$store.dispatch("searchAndFetchAllCommonIngredients", {
        vm: this,
